...
| Web activities                            | `WebActivity`                 | Submits an HTTP request using the `requests` library and publishes the response body and status code as Databricks task values.                                            |
