...
class TestDefinitionStoreBuilder:
    ...
    @pytest.mark.parametrize('definition_store_type, definition_store_options, expected_result', [
            ...
            ('factory_definition_store', {'tenant_id': 'TENANT_ID'}, pytest.raises(ValueError)),
            ('factory_definition_store', {'tenant_id': 'TENANT_ID', 'client_id': 'CLIENT_ID'},
                pytest.raises(ValueError)),
            ('factory_definition_store', {
                'tenant_id': 'TENANT_ID',
                'client_id': 'CLIENT_ID',
                'client_secret': 'SECRET'}, pytest.raises(ValueError)),
            ...
            ('workspace_definition_store', {'host_name': 'test_host_name'}, pytest.raises(ValueError)),
            ('workspace_definition_store', {'authentication_type': 'pat'}, pytest.raises(ValueError)),
            ('workspace_definition_store', {'authentication_type': None}, pytest.raises(ValueError)),
            ...
            ('json_definition_store', {'json_file_path': f'{wkmigrate.JSON_PATH}/INVALID_PATH'},
                pytest.raises(ValueError)),
