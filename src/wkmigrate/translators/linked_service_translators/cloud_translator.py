"""Translators for cloud storage linked service definitions (S3, GCS, Azure Blob).

This module normalizes Amazon S3, Google Cloud Storage, and Azure Blob Storage
